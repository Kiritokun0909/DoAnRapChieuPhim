			...
			<div class="container-fluid">
			    ...
			    <div class="row">
			      <div class="owl-carousel owl-theme nonloop owl-loaded owl-drag" >
			        <div class="card">
			          <div class="card-body">
			            <img src="https://booking.bhdstar.vn/CDN/media/entity/get/FilmPosterGraphic/HO00002703?referenceScheme=HeadOffice&allowPlaceHolder=true&height=500" class="card-img-top" height="300px">
